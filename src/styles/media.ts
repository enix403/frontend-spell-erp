...
export const minWidth = (Object.keys(sizes) as Array<keyof typeof sizes>).reduce((acc, label) => {
...
export const maxWidth = (Object.keys(sizes) as Array<keyof typeof sizes>).reduce((acc, label) => {
    acc[label] = (first: any, ...interpolations: any[]) => css`
